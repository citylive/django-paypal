...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('paypal_ipn', 'payment_status', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PayPalIPN.payment_status'
        db.alter_column('paypal_ipn', 'payment_status', self.gf('django.db.models.fields.CharField')(max_length=9))
    ...
    models = {
        'ipn.paypalipn': {
            ...
            'payment_status': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
